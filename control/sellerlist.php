...
$strSql = "select a.*,b.user_type,b.seller_level,b.skill_ids,b.city,b.province,b.indus_id,b.indus_pid,b.seller_total_num,b.seller_good_num,b.seller_level,e.shop_name,
		...
		on a.uid = b.uid left join ".TABLEPRE."witkey_auth_record c on a.uid=c.uid left join ".TABLEPRE."witkey_finance d on a.uid=d.uid left join ".TABLEPRE."witkey_shop e on e.uid=a.uid where ";
