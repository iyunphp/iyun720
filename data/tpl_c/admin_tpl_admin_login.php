<?php keke_tpl_class::checkrefresh('admin/tpl/admin_login', '1455865813' );?><!DOCTYPE HTML>
...
<title><?php echo $_lang['admin_keke_sys'];?></title>
      ...
      <tr>
        <td class="pl">
        	<div>
                ...
                <div>
                  <p>Powered by &copy;2010 <?php echo $_lang['keke_info_technology_company'];?></p>
                </div>
          	</div>
        </td>
        <td class="pr">
