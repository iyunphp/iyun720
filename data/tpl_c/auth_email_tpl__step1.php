<?php keke_tpl_class::checkrefresh('auth/email/tpl/default/step1', '1452523023' );?><!DOCTYPE HTML>
...
<!-- start -->
<form role="form" action="<?php echo $strUrl;?>&step=<?php echo $step;?>" method="post" name="editEmailForm" id="editEmailForm">
...
<input type="text" name="email" id="email" class="form-control" placeholder="填写您的邮箱地址" value="<?php echo $gUserInfo['email'];?>">
</div>
<div class="form-group">
...
邮箱地址登录。可直接使用“邮箱地址”登录到<?php echo $_K['sitename'];?>。
</p>
<p>
<i class="fa fa-arrow-circle-o-right"></i>
