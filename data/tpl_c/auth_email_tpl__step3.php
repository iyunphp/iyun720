<?php keke_tpl_class::checkrefresh('auth/email/tpl/default/step3', '1452523091' );?><!DOCTYPE HTML>
      ...
      <div class="tab_detail">
          ...
          <div class="media">
            ...
            <div class="media-body">
                <div class="panel panel-success">
                  <div class="panel-heading">
                    <h3 class="panel-title">
                      ...
                      <?php echo $auth_item['auth_title'];?>
                      <span class="label label-success"><i class="fa fa-check"></i> <?php echo $auth_tips;?></span>
                    </h3>
                  </div>
                  <div class="panel-body">
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td><?php echo $arrAuthInfo['username'];?></td>
                            <td><?php echo $arrAuthInfo['email'];?></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                ...
                <a href="index.php?do=user&view=account&op=auth&code=email&step=step1" class="btn btn-default">返回修改</a>
