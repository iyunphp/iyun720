<?php keke_tpl_class::checkrefresh('auth/realname/tpl/default/step1', '1452303108' );?><!DOCTYPE HTML>
...
<dl class="nav-list">
  ...
  <div class="content-panel">
   ...
   <a   <?php if(in_array($code,array('realname','enterprise'))) { ?>
<?php if($k === 'realname'||$k === 'enterprise') { ?>class="selected"<?php } ?>
        <?php } else { ?>
<?php if($code === $k) { ?>class="selected"<?php } ?>
        <?php } ?>

        href="index.php?do=user&view=<?php echo $view;?>&op=<?php echo $op;?>&code=<?php echo $k;?>">
...
<?php echo $v['auth_title'];?>
  ...
  <?php } } ?>
      ...
      <div class="tab_detail">
          ...
          <li <?php if($code === 'realname') { ?> class="active" <?php } ?>><a href="index.php?do=user&view=<?php echo $view;?>&op=<?php echo $op;?>&code=realname">实名认证</a></li>
          <li <?php if($code === 'enterprise') { ?> class="active" <?php } ?>><a href="index.php?do=user&view=<?php echo $view;?>&op=<?php echo $op;?>&code=enterprise">企业认证</a></li>
        </ul>
      <?php } ?>
      		<!--  start -->

          <form role="form" action="<?php echo $strUrl;?>&step=<?php echo $step;?>" method="post" name="editRealnameForm" id="editRealnameForm">
          	<input type="hidden" name="formhash" id="formhash" value="<?php echo FORMHASH;?>">

            <div class="media">
              <div class="pull-left">
                  <img class="media-object" src="<?php echo $auth_item['auth_big_ico'];?>" alt="<?php echo $auth_item['auth_title'];?>">
              </div>
              <div class="media-body">
                  ...
                  <div class="form-group">
                    ...
                    <?php if($arrAuthInfo['username']) { ?><?php echo $arrAuthInfo['username'];?><?php } else { ?><?php echo $gUserInfo['username'];?><?php } ?>
                  </div>
                  <div class="form-group">
                    <label class="control-label" for="truename">真实姓名：</label>
                    <input type="text"  name="truename" id="truename"  class="form-control" value="<?php if($arrAuthInfo['realname']) { ?><?php echo $arrAuthInfo['realname'];?><?php } else { ?><?php echo $gUserInfo['truename'];?><?php } ?>">

                  </div>
                  <div class="form-group">
                    <label class="control-label" for="idcard">身份证号：</label>
                    <input type="text"  name="idcard" id="idcard"  class="form-control" value="<?php echo $arrAuthInfo['id_card'];?>">
 ...
 <input type="hidden" name="fileid" id="fileid"  class="form-control">-->
                    <input type="hidden"  name="filepath" id="filepath"  class="form-control" value="<?php echo $arrAuthInfo['id_pic'];?>">

                    <img id="idpic_img"  <?php if($arrAuthInfo['id_pic']) { ?>src="<?php echo $arrAuthInfo['id_pic']?>"<?php } else { ?>src="tpl/default/img/Idcard.png"<?php } ?> width="200">
