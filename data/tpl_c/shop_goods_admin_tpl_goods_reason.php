<?php keke_tpl_class::checkrefresh('shop/goods/admin/tpl/goods_reason', '1452505372' );?><!DOCTYPE HTML>
...
<input type="hidden" name="ac" value="nopass">
...
<td>
<p>请输入您的原因：</p>
<textarea rows="10" cols="40" name="reason" id="reason" style="resize:none;"></textarea>
<p><button class="btn" type="button" onclick="uuu();">提　交</button></p>
</td>
</tr>
</tbody>
</table>
...
var mo = 'ok';
art.dialog.data("reason", a);
art.dialog.data("ispass", mo);
