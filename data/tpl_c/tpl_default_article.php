<?php keke_tpl_class::checkrefresh('tpl/default/article', '1452673954' );?><!DOCTYPE HTML>
...
<div  class="container">
  ...
  <div class="for-advertise">
    <?php keke_loaddata_class::ad_show('NEWSINFO_HEAD','article','') ?>
  </div>
  <!-- for-advertise end -->
    ...
    <div class="article">
      ...
      <div class="page-header article-header">
        <h1 class="ws_break"><?php echo $arrArtInfo['art_title'];?></h1>
        <ul class="article-meta">
          <li>发布时间：<?php echo date('Y年m月d日',$arrArtInfo['pub_time']) ?></li>
          <li>分类：<a href="index.php?do=articlelist&catid=<?php echo $arrArtInfo['art_cat_id'];?>"><?php echo $arrArtInfo['cat_name'];?></a></li>
        </ul>
      </div>


      <div class="article-body ws_break">
        <?php echo kekezu::filter_input(stripslashes($arrArtInfo['content'])) ?>
      ...
      <div class="article-share">
        ...
        <div class="col-sm-10">
          <div class="input-group input-group-sm ">
            <span class="input-group-addon">本文链接</span>
            <input type="text" class="form-control" id="artUrl" value="<?php echo $_K['siteurl'];?>/index.php?do=<?php echo $do;?>&id=<?php echo $arrArtInfo['art_id'];?>">

          </div>
</div>
<div class="col-sm-2 col-xs-12 po_re">
              <button type="button" id="copy-url"  class="btn btn-default btn-sm btn-block">复制文本链接</button>
        </div>
      ...
      <div class="article-footer">
        <ul class="pager">
          <li class="previous"><a href="<?php echo $_K['siteurl'];?>/index.php?do=<?php echo $do;?>&id=<?php echo $arrArtUp['art_id'];?>"><?php echo $arrArtUp['art_title'];?></a></li>
          <li class="next"><a href="<?php echo $_K['siteurl'];?>/index.php?do=<?php echo $do;?>&id=<?php echo $arrArtDown['art_id'];?>"><?php echo $arrArtDown['art_title'];?></a></li>
        </ul>
      </div>
  ...
  <div class="for-advertise">
    <?php keke_loaddata_class::ad_show('NEWSINFO_BOTTOM','article','') ?>
  </div>
  <!-- for-advertise end -->
...
<script type="text/javascript">
document.getElementById("artUrl").value=location.href;
$(function() {
...
copy : $('#artUrl').val(),
beforeCopy : function() {
$('#artUrl').offsetParent().addClass('has-info');
      		$(this).removeClass('btn-default').addClass('btn-info');
},
afterCopy : function() {
$('#artUrl').offsetParent().addClass('has-success');
