<?php keke_tpl_class::checkrefresh('tpl/default/getpassresetpwd', '1452509801' );?><!DOCTYPE HTML>
...
<?php if($authstatus) { ?>
                <form role="form" action="index.php?do=getpassresetpwd" class="form-horizontal" name="pwdResetForm" id="pwdResetForm" method="post">
                    <input type="hidden" name="formhash" id="formhash" value="<?php echo FORMHASH;?>">
                    <input type="hidden" name="encrypteuid" id="encrypteuid" value="<?php echo $encrypteuid;?>">
                    <input type="hidden" name="authsid" id="authsid" value="<?php echo $authsid;?>">
                    <div class="form-group">
                        <div class="col-xs-4 col-xs-offset-3">
                           您正在找回的帐号是：<?php echo $validInfo['userinfo']['username'];?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-4">
                            <input type="password" class="form-control" name="newpwd2" id="newpwd2" placeholder="请您输入确认密码">
                        </div>
                    </div>
...
<p>该链接已过期失效</p>
<p>请<a href="index.php?do=retrieve">点此找回密码</a>重新验证!</p>
</div>
<?php } ?>
