<?php keke_tpl_class::checkrefresh('tpl/default/goodslist', '1455866323' );?><!DOCTYPE HTML>
...
<div class="main">
    	<div class="filter">
        	<div class="container">
            	<div class="collapse navbar-collapse navbar-ex1-collapse ">                
                 <!-- <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">所有地点<b class="caret"></b></a>
                        <ul class="dropdown-menu menu-top">                            
                            <li class="dropdown-submenu"> <a tabindex="-1" href="#">云南</a>
                                <ul class="dropdown-menu">
                                    <li><a tabindex="-1" href="#">昆明</a>
                                    </li>
                                    <li class="dropdown-submenu"> <a href="#">曲靖</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="#">Level 3</a>
                                            </li>
                                            <li><a href="#">Level 3</a>
                            ...
                            <li class="dropdown-submenu"> <a tabindex="-1" href="#">上海</a>
                            <li class="dropdown-submenu"> <a tabindex="-1" href="#">广东</a>
                        </ul>
                    </li>
                </ul>
              ...
              <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">所有标签<b class="caret"></b></a>
                        <ul class="dropdown-menu menu-top">                            
                            <li class="dropdown-submenu"> <a tabindex="-1" href="#">云南</a></li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">其他刷选<b class="caret"></b></a>
                        <ul class="dropdown-menu menu-top">                            
                            <li class="dropdown-submenu"> <a tabindex="-1" href="#">云南</a></li>
                        </ul>
                    </li>
    	...
    	<div class="container goods_list">
            <div class="row" id="post-list">  			
                <?php if(is_array($arrServices)) { foreach($arrServices as $k => $v) { ?>
...
$.ajax({
url    : '/index.php?do=goodslist2&page=' + page,
type   : 'json',
