<?php keke_tpl_class::checkrefresh('tpl/default/gy/buyer_index', '1452599003' );?><!DOCTYPE HTML>
...
<ul class="step step6">
<?php if(is_array($arrOrderProgress)) { foreach($arrOrderProgress as $k => $v) { ?>
      <li class="step-item <?php if($v['step'] <= $step) { ?>action<?php } ?>">
        ...
        <div class="step-text step-bottom">
          <p><strong class="step-title "><?php if($arrOrderInfo['order_status'] == 'arbitral'&&$v['step'] =='step6') { ?> 仲裁中 <?php } else { ?> <?php echo $v['state'];?> <?php } ?></strong></p>
        </div>
      </li>
      <?php } } ?>
    </ul>
...
<div class="media">
<div class="avatar">
<?php echo  keke_user_class::get_user_pic($arrSellerInfo['uid'],'small') ?>
</div>
<div class="media-body">
<strong class="meida-heading"><?php echo $arrSellerInfo['username'];?> <?php echo $arrSellerInfo['userlevel']['pic'];?></strong>
<ul class="user-meta">
<li>最近三月收入：<span class="money"><sub>￥</sub><?php echo $arrSellerInfo['nearlyIncome'];?></span></li>
<?php if(is_array($arrAid)) { foreach($arrAid as $k => $v) { ?>
<li>
<?php echo $v['aid_name'];?>
...
<p>
简介：
<?php if($arrSellerInfo['user_type'] == '2') { ?>
<?php if($arrSellerInfo['summary']) { ?><?php echo htmlspecialchars_decode($arrSellerInfo['summary']) ?><?php } else { ?>暂未填写<?php } ?>
<?php } else { ?>
<?php if($arrSellerInfo['skill_ids']) { ?><?php echo htmlspecialchars_decode($arrSellerInfo['skill_ids']) ?><?php } else { ?>暂未填写<?php } ?>
<?php } ?>

</p>
</div>
<ul class="user-meta">
<li>来自：<?php if($arrSellerInfo['comefrom']) { ?><?php echo $arrSellerInfo['comefrom'];?><?php } else { ?>暂未填写<?php } ?></li>
<li>QQ：<?php if($arrSellerInfo['qq']) { ?> <?php echo $arrSellerInfo['qq'];?> <?php } else { ?> 暂未填写 <?php } ?></li>
<li>电话：<?php if($arrSellerInfo['phone']) { ?> <?php echo $arrSellerInfo['phone'];?> <?php } else { ?> 暂未填写 <?php } ?></li>
</ul>
<div class="btn-ctrl">
<a class="btn btn-primary btn-xs" href="index.php?do=seller&id=<?php echo $arrSellerInfo['uid'];?>">进入店铺</a>
              	<a class="btn btn-default btn-xs" href="javascript:sendMessage(<?php echo $arrSellerInfo['uid'];?>);void(0);">联系我</a>
</div>
</div>
<!-- buy-user-info end -->
<!-- 相关步骤  -->

<?php require keke_tpl_class::template ( "gy/".$reqPage."_".$step ); ?>
...
<script type="text/javascript" src="tpl/default/gy/order.js"></script>
<script type="text/javascript" >
