<?php keke_tpl_class::checkrefresh('tpl/default/msg', '1455866320' );?><!DOCTYPE HTML>
    ...
    <div class="container">
        <div class="header-website">
            <div class="brand-logo">
                <a href="<?php echo SITEURL;?>"><img src="<?php echo $strWebLogo;?>" alt="<?php echo $strPageTitle;?>"></a>
...
<hr>
<p>
<span id="countDown"><?php echo $time;?></span>
秒后自动跳转，如您的浏览器不能跳转，您可以
<a class="alert-link" href="javascript:history.go(-1);void(0);">返回上一页</a>
或点击
<a class="alert-link" <?php if($url) { ?>href="<?php echo $url;?>" <?php } else { ?>href="index.php"<?php } ?>>这里</a>
</p>
</div>
</div>
<script type="text/javascript">
var url = "<?php echo $url;?>";
var jumpTime = parseInt("<?php echo $time;?>");
function doCountDown() {
$("#countDown").html(jumpTime);
jumpTime--;
if (jumpTime < 0) {
