<?php keke_tpl_class::checkrefresh('tpl/default/single', '1452599063' );?><!DOCTYPE HTML>
...
<?php keke_loaddata_class::ad_show('NEWSINFO_HEAD','single','') ?>
</div>
<div class="single">
<!--<ul class="nav nav-tabs single-nav">-->
<?php if(is_array($_footerAbouts)) { foreach($_footerAbouts as $k => $v) { ?>
<!--<li <?php if($id==$v[ 'art_id']) { ?>class="active"<?php } ?>>
<a href="<?php if($v['art_source']) { ?><?php echo $v['art_source'];?><?php } else { ?>index.php?do=single&id=<?php echo $v['art_id'];?> <?php } ?>"><?php echo $v['art_title'];?></a>
</li>-->
<?php } } ?>
<!--<li>
<a href="index.php?do=map" target="_blank">网站地图</a>
</li>-->
<!--</ul>-->
<div class="single-body ">
<div id="server-info" class=" single-detail">
               <!-- <h1 style="text-align:center"><?php echo $arrArtInfo['art_title'];?></h1>-->
<?php echo stripslashes(htmlspecialchars_decode(stripslashes($arrArtInfo['content']))) ?>
</div>
</div>
</div>
<div class="for-advertise">
<?php keke_loaddata_class::ad_show('NEWSINFO_BOTTOM','single','') ?>
</div>
</div>
</div>
