<?php keke_tpl_class::checkrefresh('tpl/default/user/account_basic', '1452577103' );?><!DOCTYPE HTML>
...
<dl class="nav-list">
  ...
  <div class="content-panel">
      <div class="tab">
        <a <?php if($op === 'basic') { ?>class="selected"<?php } ?> href="index.php?do=user&view=account&op=basic">资料完善</a>
      <!--   <a <?php if($op === 'basic') { ?>class="contact"<?php } ?> href="index.php?do=user&view=account&op=contact">联系方式</a> -->
        <a <?php if($op === 'basic') { ?>class="skill"<?php } ?> href="index.php?do=user&view=account&op=skill">技能标签</a>
      </div>
      <div class="tab_detail">
      		<!-- 基本资料 start -->
          <?php if($intUserRole === 2) { ?>
          	<form role="form" action="<?php echo $strUrl;?>" method="post" class="form-horizontal" name="editBasicEnterPriseForm" id="editBasicEnterPriseForm">
  	<input type="hidden" name="formhash" id="formhash" value="<?php echo FORMHASH;?>">
  	<input type="hidden" name="pk[uid]" value="<?php echo $gUserInfo['uid'];?>">
       ...
       <label class="col-sm-2 control-label">所属行业：</label>
            ...
            <select class="form-control" name="indus_pid" id="indus_pid" onchange="getIndustry(this.value,'indus_id')">
              ...
              <?php if(is_array($arrTopIndustrys)) { foreach($arrTopIndustrys as $v) { ?>
              		<option value="<?php echo $v['indus_id'];?>" <?php if($gUserInfo['indus_pid'] ==$v['indus_id']) { ?> selected="selected"<?php } ?>><?php echo $v['indus_name'];?></option>
              <?php } } ?>
            </select>
          </div>
          <div class="col-sm-4">
            <select class="form-control" name="indus_id" id="indus_id">
              ...
              <?php if($gUserInfo['indus_id']) { ?>
               <?php if(is_array($arrAllIndustrys)) { foreach($arrAllIndustrys as $v) { ?>
<option value="<?php echo $v['indus_id'];?>" <?php if($gUserInfo['indus_id'] == $v['indus_id']) { ?> selected="selected"<?php } ?>><?php echo $v['indus_name'];?></option>
               <?php } } ?>
              <?php } ?>
            </select>
          </div>
    ...
    <div class="form-group">
      <label class="col-sm-2 control-label" for="company">企业/机构名称：</label>
        <div class="col-sm-8">
          <input type="text"  name="company" id="company"  class="form-control" value="<?php echo $arrEnterPriseInfo['company'];?>" <?php if($intAuthStatus) { ?> readonly="readonly"<?php } ?>>
        </div>
    ...
    <div class="form-group">
      	<label class="col-sm-2 control-label" for="licen_num">营业执照号码：</label>
        <div class="col-sm-8">
          <input type="text"  name="licen_num" id="licen_num"  class="form-control" value="<?php echo $arrEnterPriseInfo['licen_num'];?>" <?php if($intAuthStatus) { ?> readonly="readonly"<?php } ?>>
    	</div>
  	</div>
    <div class="form-group">
      	<label class="col-sm-2 control-label" for="legal">法人代表：</label>
        <div class="col-sm-8">
          <input type="text"  name="legal" id="legal"  class="form-control" value="<?php echo $arrEnterPriseInfo['legal'];?>">
    	</div>
  	</div>
    <div class="form-group">
      	<label class="col-sm-2 control-label" for="staff_num">员工人数：</label>
        <div class="col-sm-8">
          <input type="text"  name="staff_num" id="staff_num"  class="form-control" value="<?php echo $arrEnterPriseInfo['staff_num'];?>">
    	</div>
  	</div>
    <div class="form-group">
      	<label class="col-sm-2 control-label" for="run_years">经营年数：</label>
        <div class="col-sm-8">
          <input type="text"  name="run_years" id="run_years"  class="form-control" value="<?php echo $arrEnterPriseInfo['run_years'];?>">
    	</div>
  	</div>
    <div class="form-group">
      	<label class="col-sm-2 control-label" for="url">企业/机构网址：</label>
        <div class="col-sm-8">
          <input type="text"  name="url" id="url"  class="form-control" value="<?php echo $arrEnterPriseInfo['url'];?>">
    	</div>
  	</div>
    <div class="form-group">
      	<label class="col-sm-2 control-label" for="address">详细地址：</label>
        <div class="col-sm-8">
          <input type="text"  name="address" id="address"  class="form-control" value="<?php echo $gUserInfo['address'];?>">
    	</div>
  	</div>
    <div class="form-group">
      	<label class="col-sm-2 control-label" for="summary">企业简介：</label>
        <div class="col-sm-8">
          	<textarea id="summary" name="summary" rows="5"   class="form-control"> <?php echo $gUserInfo['summary'];?></textarea>
    	</div>
  	</div>
  	<!-- 邮箱 start -->
          	<div class="form-group">
       <label class="col-sm-2 control-label text-primary">基本资料　</label>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10 row">
                <div class="col-sm-7">
                <?php if($boolEmailAuth) { ?>
                   <p class="form-control-static"><?php echo $gUserInfo['email'];?></p>
                <?php } else { ?>
                	<input type="email" placeholder="邮箱" name="email" id="email" value="<?php echo $gUserInfo['email'];?>" class="form-control">
                <?php } ?>
                </div>
                <div class="col-sm-3">
<select  class="form-control" name="sect[email]">
<option value="1" <?php if($arrMemberExts['email']['v1']==1) { ?>selected="selected"<?php } ?>>不公开</option>
<option value="2" <?php if($arrMemberExts['email']['v1']==2) { ?>selected="selected"<?php } ?>>公开</option>
</select>
</div>
                <div class="col-sm-2">
                <?php if($boolEmailAuth) { ?>
                	<p class="text-success form-control-static"><i class="fa fa-check"></i> 已认证</p>
<?php } else { ?>
<a class="btn btn-default btn-sm btn-block" href="index.php?do=user&view=account&op=auth&code=email">
...
<?php } ?>
            ...
            <!-- 手机 start -->
            <div class="form-group">
              <label class="col-sm-2 control-label" for="mobile">手机 <span style="color: #a94442">*</span>：</label>
              <div class="col-sm-10 row">
                <div class="col-sm-7">
                 <?php if($boolMobileAuth) { ?>
                   <?php echo $gUserInfo['mobile'];?>
                <?php } else { ?>
                	<input type="text" placeholder="手机" name="mobile" id="mobile" value="<?php echo $gUserInfo['mobile'];?>" class="form-control">
                <?php } ?>

                </div>
                <div class="col-sm-3">
<select  class="form-control" name="sect[mobile]">
<option value="1" <?php if($arrMemberExts['mobile']['v1']==1) { ?>selected="selected"<?php } ?>>不公开</option>
<option value="2" <?php if($arrMemberExts['mobile']['v1']==2) { ?>selected="selected"<?php } ?>>公开</option>
</select>
</div>
            ...
            <!-- QQ start -->
            <div class="form-group">
              <label class="col-sm-2 control-label" for="qq">QQ <span style="color: #a94442">*</span>：</label>
              <div class="col-sm-10 row">
                <div class="col-sm-7">
                  <input type="text" placeholder="QQ" name="qq" id="qq" value="<?php echo $gUserInfo['qq'];?>" class="form-control">
                </div>
                <div class="col-sm-3">
<select  class="form-control" name="sect[qq]">
<option value="1" <?php if($arrMemberExts['qq']['v1']==1) { ?>selected="selected"<?php } ?>>不公开</option>
<option value="2" <?php if($arrMemberExts['qq']['v1']==2) { ?>selected="selected"<?php } ?>>公开</option>
</select>
</div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10 row">
                <div class="col-sm-7">
                  <input type="text" placeholder="微信" name="msn" id="msn" value="<?php echo $gUserInfo['msn'];?>" class="form-control">
                </div>
                <div class="col-sm-3">
<select  class="form-control" name="sect[msn]">
<option value="1" <?php if($arrMemberExts['msn']['v1']==1) { ?>selected="selected"<?php } ?>>不公开</option>
<option value="2" <?php if($arrMemberExts['msn']['v1']==2) { ?>selected="selected"<?php } ?>>公开</option>
</select>
</div>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10 row">
                <div class="col-sm-7">
                  <input type="text" placeholder="固定电话" name="phone" id="phone" value="<?php echo $gUserInfo['phone'];?>" class="form-control">
                </div>
                <div class="col-sm-3">
<select  class="form-control" name="sect[phone]">
<option value="1" <?php if($arrMemberExts['phone']['v1']==1) { ?>selected="selected"<?php } ?>>不公开</option>
<option value="2" <?php if($arrMemberExts['phone']['v1']==2) { ?>selected="selected"<?php } ?>>公开</option>
</select>
</div>
              </div>
            </div>
...
<option value="<?php echo $v['id'];?>" <?php if($gUserInfo['province']==$v['id']) { ?>selected="selected"<?php } ?>><?php echo $v['name'];?></option>
<?php } } ?>
                  </select>
                  </div>
                <div class="col-sm-3">
...
<?php if($gUserInfo['city']) { ?>
<?php if(is_array($arrCity)) { foreach($arrCity as $k => $v) { ?>
<option value="<?php echo $v['id'];?>" <?php if($gUserInfo['city']==$v['id']) { ?>selected="selected"<?php } ?>><?php echo $v['name'];?></option>
<?php } } ?>
<?php } ?>
                  </select>
                </div>
...
<?php if($gUserInfo['area']) { ?>
<?php if(is_array($arrArea)) { foreach($arrArea as $k => $v) { ?>
<option value="<?php echo $v['id'];?>" <?php if($gUserInfo['area']==$v['id']) { ?>selected="selected"<?php } ?>><?php echo $v['name'];?></option>
<?php } } ?>
<?php } ?>
                  </select>
                </div>
  	...
  	<div class="form-group">
          ...
          <?php } else { ?>
          	<form role="form" action="<?php echo $strUrl;?>" method="post" class="form-horizontal" name="editBasicForm" id="editBasicForm">
         	<input type="hidden" name="formhash" id="formhash" value="<?php echo FORMHASH;?>">
         	<input type="hidden" name="pk[uid]" value="<?php echo $gUserInfo['uid'];?>">
         	<input type="hidden" name="is_perfect" value="1">
         	 <div class="form-group">
...
<option value="<?php echo $v['indus_id'];?>" <?php if($gUserInfo['indus_id'] == $v['indus_id']) { ?> selected="selected"<?php } ?>><?php echo $v['indus_name'];?></option>
           ...
           <div class="form-group">
             <label class="col-sm-2 control-label" for="truename">真实姓名 <span style="color: #a94442">*</span>：</label>
               <div class="col-sm-4">
                 <input type="text"  name="truename" id="truename"  class="form-control" value="<?php echo $gUserInfo['truename'];?>" <?php if($intAuthStatus) { ?> readonly="readonly"<?php } ?>>
               </div>
               <div class="col-sm-2">
                 <select class="form-control" name="sex">
                     <option value="-1">保密</option>
                     <option value="男" <?php if($gUserInfo['sex'] === '男') { ?> selected="selected"<?php } ?>>男</option>
                     <option value="女" <?php if($gUserInfo['sex'] === '女') { ?> selected="selected"<?php } ?>>女</option>
                   </select>
               </div>
               <?php if(!$intAuthStatus) { ?>
               <div class="col-sm-2">
           ...
           <div class="form-group">
             ...
             <div class="col-sm-10 row">
               <div class="col-sm-8">
                 <input type="text" data-date-format="yyyy-mm-dd" data-date="<?php echo date('Y-m-d',time()) ?>" placeholder="出生日期" name="birthday" id="birthday" value="<?php echo $gUserInfo['birthday'];?>" class="form-control form_datetime" readonly="readonly">
...
<script src="static/js/model/user/account.js"></script>
