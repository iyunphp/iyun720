<?php keke_tpl_class::checkrefresh('tpl/default/user/account_index', '1452523124' );?><!DOCTYPE HTML>
                ...
                <div class="media-body">
                    <div class="user-info">
                        ...
                        <div class="media-min">
                            ...
                            <div class="p-row1">
                                个人主页:<?php if($autoshop==1) { ?>已开启<?php } else { ?>暂无&nbsp;&nbsp;&nbsp;请前去<a href="index.php?do=seller&id=<?php echo $gUid;?>">已开启</a><?php } ?>
                            </div>
                        </div>
