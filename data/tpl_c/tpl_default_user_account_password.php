<?php keke_tpl_class::checkrefresh('tpl/default/user/account_password', '1452522925' );?><!DOCTYPE HTML>
...
<dl class="nav-list">
  ...
  <div class="content-panel">
      <div class="tab">
      	<a <?php if($op === 'password') { ?>class="selected"<?php } ?> href="index.php?do=user&view=account&op=password" >修改登录密码</a>
        <!--<a <?php if($op === 'security') { ?>class="selected"<?php } ?> href="index.php?do=user&view=account&op=security" >安全密码</a>-->
      </div>
      <div class="tab_detail">
      		...
      		<p class="text-info"><i class="fa fa-info-circle"></i> 为了您的权益与安全，请不要将登录密码透露给他人，并且牢记您的新密码</p>
      		 <div class="mb_10"></div>
      		<!-- 基本资料 start -->
          <form role="form" action="<?php echo $strUrl;?>" method="post" class="form-horizontal" name="editPasswordForm" id="editPasswordForm">
