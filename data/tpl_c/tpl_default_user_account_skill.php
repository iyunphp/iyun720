<?php keke_tpl_class::checkrefresh('tpl/default/user/account_skill', '1452523107' );?><!DOCTYPE HTML>
...
<dl class="nav-list">
  ...
  <div class="content-panel">
      <div class="tab">
        <a <?php if($op === 'skill') { ?>class="selected"<?php } ?> href="index.php?do=user&view=account&op=skill">擅长</a>
      </div>
      <div class="tab_detail">

            <!--from表单 start-->
            <form role="form" action="<?php echo $strUrl;?>" method="post" name="editSkillForm" id="editSkillForm">
                <input type="hidden" name="formhash" id="formhash" value="<?php echo FORMHASH;?>">
<input type="hidden" name="pk[uid]" value="<?php echo $gUserInfo['uid'];?>">
<input type="hidden" name="strUserTags" id="strUserTags" value="<?php echo $gUserInfo['skill_ids'];?>">
<div class="form-group clearfix mt_20">


                <div class="col-sm-6">
                	<label for="indus_pid" class="mb_10">选择行业 <small>选择行业获取相应技能标签</small></label>
<select name="indus_pid" id="indus_pid" class="form-control"
                                	onchange="InsertIndus($('#indus_pid option:selected').val(),'skill_tags');">
                                    <?php if(is_array($indus_p_arr)) { foreach($indus_p_arr as $v) { ?>
                                    	<option <?php if($user_indus['indus_pid']==$v['indus_id']) { ?>  selected="selected"<?php } ?>  value="<?php echo $v['indus_id'];?>"><?php echo $v['indus_name'];?>  </option>
                                    <?php } } ?>
                                	</select>
                            	<div class="tags-box" id="skill_tags">
                            		标签显示在这里
                            	</div>
...
<div class="col-sm-6">
<label class="mb_10">选择的标签 <small>最多5项</small></label>
<!--tags_box 标签 start-->
                                <div class="tags_box">
                ...
                <div class="help-block">
                  	已选择的技能标签，可点击 “&times;” 去除。请确保点击”保存“来保存设置
                </div>
                </div>
              ...
              <div class="text-center">
                <button class="btn btn-default" type="submit" onclick="return save_skill();" value="1">保存</button>
...
<script type="text/javascript" src="static/js/model/user/skill.js" ></script>
<script type="text/javascript" src="static/js/jqplugins/tagsinput/jquery.tagsinput.js" ></script>
<link href="static/js/jqplugins/tagsinput/jquery.tagsinput.css" rel="stylesheet" charset="utf-8">
<script type="text/javascript" src="static/js/jqplugins/tagsinput/jquery.tagsinput.min.js" ></script>
<script type="text/javascript" >
var arrUserSkill = "<?php echo $gUserInfo['skill_ids'];?>";
</script>
