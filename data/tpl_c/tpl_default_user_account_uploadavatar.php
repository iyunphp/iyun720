<?php keke_tpl_class::checkrefresh('tpl/default/user/account_uploadavatar', '1452556804' );?><!DOCTYPE HTML>
  ...
  <div class="content-panel">
      ...
      <div class="tab_detail">
            ...
            <div class="img_cut mb_10 ">
                <div style="width:520px; margin:auto;"><?php echo $strUserSwf;?></div>
            </div>
