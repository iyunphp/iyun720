<?php keke_tpl_class::checkrefresh('tpl/default/user/wk_index', '1452665806' );?><!DOCTYPE HTML>
          ...
          <div class="user-info">
            ...
            <div class="top-right">
              <div class="notice">
                ...
                <span class="number"><?php echo $intService;?></span>
              </div>
  <div class="notice">
                <i class="fa fa-flag"></i>
                <a href="index.php?do=user&view=wk&op=gy&s=seller_confirm">新雇佣</a>
                <span class="number"><?php echo $intGy;?></span>
              </div>
              <div class="notice">
                <i class="fa fa-comment"></i>
                <a href="index.php?do=user&view=wk&op=mark&type=1">待评价</a>
                <span class="number"><?php echo $intMarkW;?></span>
              </div>
    ...
    <div class="horizontal-row">
      <div class="user-type">
          ...
          <div class="type-body1">
            <ul class="count">
              ...
              <li class="item"><span class="num"><?php echo kekezu::favorableRate($gUserInfo['uid'],1) ?><sub>%</sub></span>好评率：</li>
              <li class="item"><span class="num"><?php echo $gUserInfo['accepted_num'];?></span>中标稿件数：</li>
              <li class="item"><span class="num"><sub></sub><?php  echo keke_curren_class::output(floatval($floatBidTask[0]['cash']),-1);  ?></span>获得任务款：</li>
              <li class="item"><span class="num"><?php echo $floatSaleService['0']['count'];?></span>出售服务数：</li>
              <li class="item"><span class="num"><sub></sub><?php  echo keke_curren_class::output(floatval($floatSaleService[0]['cash']),-1);  ?></span>获得服务款：</li>
            </ul>
          </div>
      ...
      <div class="user-type">
          ...
          <div class="type-body1">
            <ul class="count">
             <?php if(is_array($arr)) { foreach($arr as $key => $val) { ?>
              <li class="item1"><span class="desc"><?php echo $val['dongtai'];?></span><div class="time"><?php echo  CommonClass::getStatus($val['time']); ?></div></li>
            <?php } } ?>
            </ul>
          </div>
    ...
    <div class="horizontal-row">
      <div class="user-type">
          ...
          <table class="table table-hover count1">
            ...
            <tbody>
              <?php if(is_array($arrFavorite)) { foreach($arrFavorite as $v) { ?>
              <tr>
                <td><a href="index.php?do=task&id=<?php echo $v['obj_id'];?>"  class="list-desc"><?php echo $v['obj_name']?></a></td>
                <td><span class="money"><?php $a=ServiceClass::getTaskByObj_id($v['obj_id']);echo $a['task_cash'] ?></span></td>
                <td><a href="index.php?do=seller&id=<?php $a=ServiceClass::getTaskByObj_id($v['obj_id']);echo $a['uid'] ?>"><?php $a=ServiceClass::getTaskByObj_id($v['obj_id']);echo $a['username'] ?></a></td>
              </tr>
              <?php } } ?>
            </tbody>
          </table>
      ...
      <div class="user-type">
          ...
          <div class="type-heading">
            <h3 class="type-title">我卖出的作品信息</h3>
          </div>
          <div class="type-list">
            <table class="table table-hover count1">
            <thead>
            ...
            <tbody>
              <?php if(is_array($arrRercod)) { foreach($arrRercod as $k => $v) { ?>
              <tr>
                <td><a href="index.php?do=goods&id=<?php echo $v['service_id'];?>" class="list-desc1"><?php echo $v['title'];?></a></td>
                <td><?php echo $v['sale_num'];?></td>
                <td><?php echo $v['buytime'];?></td>
                <td><span class="money"><?php echo $v['total_sale'];?></span></td>
              </tr>
              <?php } } ?>
            </tbody>
          </table>
