<?php keke_tpl_class::checkrefresh('tpl/default/user/wk_mark', '1452475904' );?><!DOCTYPE HTML>
  ...
  <div class="content-panel">
    ...
    <div class="tab_detail">
    	<div class="form-group" style="overflow: hidden; ">
    		<label class="col-sm-2">评价类型: </label>
    		<div class="col-sm-10">
    			<ul class="nav nav-pills second-nav" style="margin:0;">
      	<li <?php if($type == '') { ?> class="active" <?php } ?>>
      		<a href="<?php echo $strUrl;?>&type=">全部</a>
      	</li>
        <li <?php if($type == 1) { ?> class="active" <?php } ?>>
            <a href="<?php echo $strUrl;?>&type=1">待评价</a>
        </li>
        <li <?php if($type == 2) { ?> class="active" <?php } ?>>
            <a href="<?php echo $strUrl;?>&type=2">我做出的评价</a>
        </li>
        <li <?php if($type == 3) { ?> class="active" <?php } ?>>
            <a href="<?php echo $strUrl;?>&type=3">我接受的评价</a>
        </li>
    </ul>
    		</div>
    	</div>
    	...
    	<!--<div class="form-group" style="overflow: hidden; ">
    		...
    		<div class="col-sm-10">
    			<ul class="nav nav-pills second-nav"style="margin:0;">
      	<li <?php if($obj == '') { ?> class="active" <?php } ?>>
      		<a href="<?php echo $strUrl;?>&obj=">全部</a>
      	</li>
        <li <?php if($obj == "goods") { ?> class="active" <?php } ?>>
            <a href="<?php echo $strUrl;?>&obj=goods">作品</a>
        </li>
        <li <?php if($obj == "task") { ?> class="active" <?php } ?>>
            <a href="<?php echo $strUrl;?>&obj=task">任务</a>
        </li>
        <li <?php if($obj == "gy") { ?> class="active" <?php } ?>>
            <a href="<?php echo $strUrl;?>&obj=gy">雇佣</a>
        </li>
    </ul>
    		</div>
    	</div>-->
      ...
      <div class="table-responsive">
        ...
        <tbody>
        	<?php if($arrData) { ?>
        	<?php if(is_array($arrData)) { foreach($arrData as $k => $v) { ?>
          		<tr>
            		<td width="7%"><?php echo $v['mark_id'];?></td>
            		<td width="8%"><?php echo $arrObj[$v['model_code']];?></td>
            		<td width="20%"><?php echo $v['mark_content'];?></td>
            		<td width="10%"><?php echo $arrMarkStatus[$v['mark_status']];?></td>
            		<td width="5%"><?php if($v['mark_time']){echo date('Y-m-d H:m:s',$v['mark_time']); } ?></td>
            		<td width="10%">
            			<?php if($v['uid'] == $gUid) { ?>
我接受的评价
<?php } elseif($v['by_uid'] == $gUid) { ?>
我做出的评价
<?php } ?>
</td>
            		<td width="25%">
<?php if($v['model_code'] == 'goods') { ?>
            				<a href="index.php?do=goods&id=<?php echo $v['origin_id'];?>" target="_blank" class="btn btn-default">查看详情</a>
<?php } elseif($v['model_code'] == 'gy') { ?>
            				<a href="index.php?do=gy&id=<?php echo $gUid;?>&orderId=<?php echo $v['obj_id'];?>" target="_blank" class="btn btn-default">查看详情</a>
<?php } else { ?>
            				<a href="index.php?do=task&id=<?php echo $v['origin_id'];?>" target="_blank" class="btn btn-default">查看详情</a>
<?php } ?>
<?php if($v['uid'] == $gUid && $v['mark_status'] != 1 && $v['mark_count'] < 2) { ?>
            				<a href="javascript:sendMessage(<?php echo $v['by_uid'];?>);void(0);" class="btn btn-default">私信对方</a>
<?php } elseif($v['by_uid'] == $gUid && $v['mark_status'] != 1 && $v['mark_count'] < 2) { ?>
<?php if($v['model_code'] == 'goods') { ?>
            					<a href="index.php?do=order&sid=<?php echo $v['origin_id'];?>&orderId=<?php echo $v['obj_id'];?>" target="_blank" class="btn btn-default">
            						<?php if($v['mark_status'] == 0) { ?>
评价
<?php } else { ?>
            							修改评价
<?php } ?>
...
<?php } elseif($v['model_code'] == 'gy') { ?>
            					<a href="index.php?do=gy&id=<?php echo $v['by_uid'];?>&orderId=<?php echo $v['obj_id'];?>" target="_blank" class="btn btn-default">
            						<?php if($v['mark_status'] == 0) { ?>
评价
<?php } else { ?>
            							修改评价
...
<?php } else { ?>
            					<a class="btn btn-default" href="javascript:mark(1,'<?php echo $v['obj_id'];?>','<?php echo $v['origin_id']?>','wk');void(0);">
            						<?php if($v['mark_status'] == 0) { ?>
评价
<?php } else { ?>
            							修改评价
