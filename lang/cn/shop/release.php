...
$lang=array(
  /*goods release*/
	 ...
	 'assessment'=>'互评',
	 'end'=>'结束', 
     'goods_info_notice'=>'此类型适合贩卖源代码、设计图等，已经有文件的作品。',
     'flow_map'=>'流程图',
    ...
    /*step2*/
     ...
     'you_submit_goods_notice'=>'您要发布什么作品?5-50字',
     'please_input_goods_name'=>'请填写作品名称，5-50字',
     ...
     'picture_show_in_goods_detail'=>'此图片用于作品详细页展示',
     'index_picture'=>'封面图片:',
     'index_picture_size'=>'尺寸为100x100PX，100KB以内，支持.jpg,.gif,.png格式，RGB模式。',
     'picture_show_in_goods_list'=>'此图片用于作品列表页展示',
     'sell_price'=>'出售价格',
     'sell_min_money'=>'售价最小金额为：',
     'input_goods_sell_price'=>'填写作品售价。最小金额为：',
     'sell_company'=>'出售单位:',
     'pay_way'=>'交付方式',
     'goods_original'=>'作品源件：',
     ...
     'confirm_submit'=>'确认发布',
     /*step4*/
     'congrate_goods_submit_success'=>'恭喜，作品发布成功',
     'please_wait_audit'=>'请等待审核',
     'confirm_now_to_view_goods'=>'确认，现在去查看作品',
     'back_continue_submit_goods'=>'返回，继续发布新作品',
...
/*shop_release.php*/
     ...
     'now_no_goods_model'=>'暂无作品模型开放',
     'choose_goods_type'=>'选择作品类型',
     'choose_model_to_confirm_trans'=>'选择模型来确定交易进行的方式',
     'input_goods_description'=>'填写描述',
     'from_description_to_confirm_detail'=>'通过描述来确定作品的详细信息',
     'pub_success'=>'发布成功',
...
/**shelves.htm**/
	...
	'back'=>'后退',
	'forward'=>'前进',
	'value_added_can_bigger_not_than_delivery_time'=>'作品增值属性的有效期不能大于交稿期限',
	'haved_buy'=>'使用',
	'tian'=>'天',
