...
class keke_glob_class {
    ...
    public static function getRegionConfig(){
    	global $basic_config;
    	$config = array();
    	$config['region_search_switch'] = $basic_config['region_search_switch'];
		if($basic_config['region_search_switch'] =='1'){
			$config['region_search_shop'] = $basic_config['region_search_shop'];
			$config['region_search_task'] = $basic_config['region_search_task'];
		}else{
