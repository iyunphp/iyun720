...
switch ($step) {
	...
	case 'step2':
		if (isset($formhash)&&kekezu::submitcheck($formhash)) {
			...
			!$_SESSION[$stdCacheName] and kekezu::show_msg($_lang ['friendly_notice'],"index.php?do=pubgoods&id=$id",2,"该作品已提交，不可再返回修改！","warning");
			$objRelease->check_access($step, $id, $arrPubInfo);
...
require keke_tpl_class::template ( 'pubgoods2' );
die();