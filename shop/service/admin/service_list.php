	...
	switch ($ac) {
		...
		case 'off_shelf' : 
			if ($is_submit == "1") {
				...
				keke_msg_class::send_private_message ( '作品下架', '您的作品<a href="index.php?do=goods&id=' . $service_id . '">' . $arrServiceInfo ['title'] . '</a>被管理员下架，下架原因:' . $reason, $serviceInfo ['uid'], $serviceInfo ['username'] );
